...
export default {
  ...
  mounted () {
    ...
    //   this.loading = false
    // })
    _this.echartsUserAction.setOption(this.option('用户活跃度', '{b}日{c}度', ['1', '2', '3', '4', '5', '6', '7'], [33, 181, 248, 149, 77, 86, 6]))
    _this.echartsQuestion.setOption(this.option('题目月数量', '{b}日{c}题', ['1', '2', '3', '4', '5', '6', '7'], [111, 349, 292, 263, 269, 302, 117]))
  },
  methods: {
